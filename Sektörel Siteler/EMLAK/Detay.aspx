    ...
    <div class="container">
                <div class="standards">
						<ul class="selectors_wrapper">
							<a href="Detay.aspx"><li class="selector active" data-selector="1">Resimler</li></a>
							<a href="Detay.aspx"><li class="selector" data-selector="2">Ulaşım</li></a>
							<a href="Detay.aspx"><li class="selector" data-selector="3">Video</li></a>
					    </ul>
						<div class="standard_content" style="height: 439px;">
							<div class="standard active" data-selector="1">
						 	     <ul class="single_grid">
						 	     	<li><img src="images/s2.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s3.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s4.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s5.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s6.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s7.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s8.jpg" class="img-responsive" alt=""/></li>
						 	     	<li><img src="images/s9.jpg" class="img-responsive" alt=""/></li>
		...
		<div class="col-md-9 single_box1">
			<ul class="single_box">
		     <li><i class="fa fa-building-o icon1"> </i> 2  Yatak Odası</li>
		     <li><i class="fa fa-retweet icon1"> </i> 1  Banyosu</li>
		     <li><i class="fa fa-plane icon1"> </i> 1 Garaj</li>	
		    </ul>
		    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
	        <p class="single_desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>	
	    </div>
		<div class="col-md-3">
        ...
        <div class="about_grid2">
        	<h3>Örnek Emlak Çalışanlarımız</h3>
