<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Duyurular.aspx.cs" Inherits="Blog" %>
            ...
            <div class="col-md-12">
                <ul class="breadcrumb">
                    ...
                    <li style="font-size: 15px; color: #005C7B;">
                        ...
                        <asp:Label ID="Label1" runat="server" Text="<%$ Resources:duyuru%>"></asp:Label>
        ...
        <div class="container" id="contact">
                    ...
                    <div class="col-md-12">
                        <section>
                            <div class="col-md-7 col-md-offset-5" style="padding-bottom: 20px">
                                <h2 class="heading">
                                    <asp:Label ID="Label3" runat="server" Text="<%$ Resources:duyuru2%>"></asp:Label>
                                </h2>
                            </div>
            ...
            <section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <h2>
                            <asp:Label ID="Label4" runat="server" Text="<%$ Resources:bslk%>"></asp:Label>
