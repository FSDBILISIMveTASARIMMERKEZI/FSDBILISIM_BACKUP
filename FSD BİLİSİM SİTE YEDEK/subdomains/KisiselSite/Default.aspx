    ...
    <div class="container sections-wrapper">
        ...
        <p>It's a good idea to include your personal interests and hobbies as well. Commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec.Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
               ...
               <section class="latest section">
                    <div class="section-inner">
                        <h2 class="heading">Projelerim</h2>
                        <div class="content">    
                                               
                            <div class="item featured text-center">
                                <h3 class="title"><a href="Default.aspx" target="_blank">Patates Salatası Uygulaması</a></h3>
                                <p class="summary">Estetik Mobil Uygulama</p>
                                ...
                                <a class="btn btn-cta-secondary" href="Default.aspx" target="_blank"><i class="fa fa-thumbs-o-up"></i> Detaya Git</a>                 
                            </div><!--//item-->
                            <hr class="divider" />
                            <div class="item row">
                                ...
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="Default.aspx" target="_blank">
                                           Hızlı ürünler için tasarlanmıştır</a></h3>
                                    ...
                                    <p><a class="more-link" href="Default.aspx" target="_blank"><i class="fa fa-external-link"></i> Daha Fazlası</a></p>
                                </div><!--//desc-->                          
                            </div><!--//item-->
                            
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="Default.spx" target="_blank">
                                <img class="img-responsive project-image" src="assets/images/projects/project-1.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="Default.aspx" target="_blank">Yeni Başlayanlar İçin</a></h3>
                                    <p>You can put one of your secondary projects here. Suspendisse in tellus dolor. Vivamus a tortor eu turpis pharetra consequat quis non metus. Aliquam aliquam, orci eu suscipit pellentesque, mauris dui tincidunt enim, eget iaculis ante dolor non turpis.</p>
                                    <p><a class="more-link" href="Default.aspx" target="_blank"><i class="fa fa-external-link"></i> Daha Fazlası</a></p>
                                </div><!--//desc-->                          
                            </div><!--//item-->
                            ...
                            <div class="item row">
                                <a class="col-md-4 col-sm-4 col-xs-12" href="Default.aspx" target="_blank">
                                <img class="img-responsive project-image" src="assets/images/projects/project-2.png" alt="project name" />
                                </a>
                                <div class="desc col-md-8 col-sm-8 col-xs-12">
                                    <h3 class="title"><a href="Default.aspx" target="_blank">Mobil Uygulamalar için </a></h3>
                ...
                <section class="projects section">
                    <div class="section-inner">
                        <h2 class="heading">Diğer Projeler</h2>
                        <div class="content">
                            <div class="item">
                                <h3 class="title"><a href="#">Proje Başlığı</a></h3>
                                ...
                                <p><a class="more-link" href="https://wrapbootstrap.com/theme/delta-promote-mobile-app-effectively-WB09R23P8?ref=3wm" target="_blank"><i class="fa fa-external-link"></i> Daha Fazlası</a></p>
                            </div><!--//item-->
                            <div class="item">
                                <h3 class="title"><a href="#">Proje Başlığı</a> <span class="label label-theme">Açık Kaynak</span></h3>
                            ...
                            <a class="btn btn-cta-secondary" href="#">CoderWall Hakkında Daha Fazla <i class="fa fa-chevron-right"></i></a>
                ...
                <section class="experience section">
                    <div class="section-inner">
                        <h2 class="heading">İş Deneyimi</h2>
                        <div class="content">
                            <div class="item">
                                <h3 class="title"> Developer  Kurucu <span class="place"><a href="#">Başlangıç</a></span> <span class="year">(2014)</span></h3>
                            ...
                            <div class="item">
                                <h3 class="title">Yazılım Mühendisi <span class="place"><a href="#">Google</a></span> <span class="year">(2013 - 2014)</span></h3>
                            ...
                            <div class="item">
                                <h3 class="title">Yazılım Mühendisi<span class="place"><a href="#">eBay</a></span> <span class="year">(2012 - 2013)</span></h3>
                ...
                <section class="github section">
                    <div class="section-inner">
                        <h2 class="heading">Benim Proje Yönetim Sistemim</h2>
                        <p>You can embed your GitHub activities using Casey Scarborough's <a href="http://caseyscarborough.com/projects/github-activity/" target="_blank">proje Yönetim Sistemi Akışı</a> widget. You can also take a screenshot of your GitHub chart and put it here for fun.</p>
            ...
            <div class="secondary col-md-4 col-sm-12 col-xs-12">
                 <aside class="info aside section">
                    <div class="section-inner">
                        <h2 class="heading sr-only">Temel Bilgiler</h2>
                        <div class="content">
                            <ul class="list-unstyled">
                                <li><i class="fa fa-map-marker"></i><span class="sr-only">Yer:</span>Ankara, İzmir</li>
                                <li><i class="fa fa-envelope-o"></i><span class="sr-only">Email:</span><a href="#">k.adı@website.com</a></li>
                ...
                <aside class="skills aside section">
                    <div class="section-inner">
                        <h2 class="heading">Becerilerim</h2>
                        <div class="content">
                            <p class="intro">
                            ...
                            <div class="skillset">
                                ...
                                <p><a class="more-link" href="#"><i class="fa fa-external-link"></i>Daha Fazlası</a></p> 
                            </div>              
                        </div><!--//content-->  
                    </div><!--//section-inner-->                 
                </aside><!--//section-->
                ...
                <aside class="list music aside section">
                    <div class="section-inner">
                        <h2 class="heading">En çok sevdiğim müzikler</h2>
                        <div class="content">
                            <ul class="list-unstyled">
                ...
                <aside class="list conferences aside section">
                    <div class="section-inner">
                        <h2 class="heading">Konferanslar</h2>
                        <div class="content">
                            <ul class="list-unstyled">
                ...
                <aside class="credits aside section">
                    <div class="section-inner">
                        <h2 class="heading">Özelliklerim</h2>
                        <div class="content">
                            <ul class="list-unstyled">
                            ...
                            <a class="btn btn-cta-secondary btn-follow" href="https://twitter.com/3rdwave_themes" target="_blank"><i class="fa fa-twitter"></i> Twitter</a>
                            <a class="btn btn-cta-primary btn-download" href="Default.aspx" target="_blank"><i class="fa fa-download"></i> indir</a>
                        </div><!--//content-->
                    </div><!--//section-inner-->
                </aside><!--//section-->
