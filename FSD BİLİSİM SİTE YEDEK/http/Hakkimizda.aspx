<%@ Page Title="fsdbilisim.com|RESPONSİVE WEB TASARIM AJANSI|SEO|MOBİL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Hakkimizda.aspx.cs" Inherits="Hakkimizda" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="lead" style="text-align:justify;text-indent:30px">
                            Günümüz teknolojisinde  iyi bir doktora, iyi bir öğretmene, iyi bir mimara,iyi bir mühendise, iyi bir avukata, iyi bir danışmana muhakkak ihtiyacımız  olur. Bilişim teknolojileri de en az bu alanlar kadar hatta daha fazlasıyla insan 
                 hayatına etkisi vardır. Bu ihtiyaçların karşılanmasında da bilişim teknolojileri ön sıralada gelmektedir. Bilişim dünyasında her geçen gün  artan ihtiyacların başında nitelikli bilişim teknik destek ihtiyacı, profesyonel tasarım ve yazılım çözümleri gelmektedir.
                 Bu ihtiyaçları sunan interaktif bir web ajansına da kesinlikle ihtiyacınız vardır. Bu alanlardaki ihtiyaçları www.fsdbilisim.com.tr sunmaktadır. Responsive Web Tasarımın Yeni Yüzünü www.fsdbilisim.com.tr de bulabilirsiniz. Mobil Tasarımın Rahatlığını,İşinizi İnternete Taşımanın 
                 kolaylığını fsdbilisim.com.tr de fark edebilirsiniz. SEO uygulamaları ile sitenizin arama motorlarında (google, yahoo vs.) daha üst sıralara taşıyabilirsiniz.Firmanızın farkındalığını,popülaritesini,markasını,müşteri memnuniyetini arttırabilirsiniz.
                 Firmanızın kimliğini yansıttıkları için son derece önemli,dikkat çekici ve hatırlanabilir en şık
                 kartvizit ve logolarınızı bulabileceğiniz adres www.fsdbilisim.com.tr
                        </p>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordionThree" href="#collapse3a">Accordion item no.1
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordionThree" href="#collapse3b">Accordion item no.2
                                ...
                                <div id="collapse3b" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <p>
                                                    It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards the viewer. Gregor then turned to look out the window
                                                        at the dull weather. Drops of rain could be heard hitting the pane, which made him feel quite sad.
                                                </p>
                                                <p>
                                                    It showed a lady fitted out with a fur hat and fur boa who sat upright, raising a heavy fur muff that covered the whole of her lower arm towards the viewer. Gregor then turned to look out the window
                                                        at the dull weather. Drops of rain could be heard hitting the pane, which made him feel quite sad.
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordionThree" href="#collapse3c">Accordion item no.3 a little too small
                        ...
                        <div class="team-member" data-animate="fadeInUp">
                            <div class="image">
                                <a href="team-member.html">
                                    <img src="img/person-1.jpg" alt="sayac" class="img-responsive img-circle">
                                </a>
                            </div>
                                ...
                                <div class="testimonial same-height-always">
                                    ...
                                    <div class="bottom">
                                        ...
                                        <div class="name-picture">
                                            <img class="" alt="" src="img/person-1.jpg" alt="sayac">
                                            <h5>John McIntyre</h5>
                                            <p>CEO, TransTech</p>
                                        </div>
                                    </div>
