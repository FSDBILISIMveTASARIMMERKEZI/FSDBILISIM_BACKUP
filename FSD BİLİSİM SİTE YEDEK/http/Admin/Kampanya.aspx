<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/yonetici.master" AutoEventWireup="true" CodeFile="Kampanya.aspx.cs" Inherits="Admin_Kampanya" %>
        ...
        <div class="md-card-content">
            <div class="uk-grid" data-uk-grid-margin>
                ...
                <div class="uk-width-medium-1-2">
                    ...
                    <asp:Button ID="btnYeni" runat="server" Text="Yeni" CssClass="md-btn md-btn-primary uk-margin-small-top" Style="float: right;" OnClick="btnYeni_Click" />
                </div>
            </div>
            ...
            <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rptKampanya" runat="server" OnItemDataBound="rptKampanya_ItemDataBound">
                        <ItemTemplate>
                            <tr>

                                <td><a href="KampanyaDetay.aspx?id=<%# Eval("id") %>"><i class="md-icon material-icons">&#xE254;</i></a></td>
                                <td><%# Eval("urunAdi") %></td>
                                <td><%# Eval("urunKodu") %></td>
                                <td>
